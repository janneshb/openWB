...
var options = {
	...
	onSuccess: function () {
		console.log("connected to MQTT, resetting counter");
		retries = 0;
	...
	onFailure: function (message) {
		retries = retries + 1;
		console.log("connection to MQTT failed, incrementing counter: " + retries);
...
client.onConnectionLost = function (responseObject) {
	console.log("connection to MQTT separated, retries: " + retries);
	setTimeout(function() { client.connect(options); }, 5000);
};
